...
exports.tcp = ({ port = undefined, address = '127.0.0.1' } = { address: '127.0.0.1' }) => {
...
exports.udp = ({ port = undefined, address = '127.0.0.1' } = { address: '127.0.0.1' }) => {
...
exports.http = ({ port = undefined, address = '127.0.0.1' } = { address: '127.0.0.1' }) => {
...
exports.https = ({ port = undefined, address = '127.0.0.1', key = undefined, certificate = undefined } = { address: '127.0.0.1' }) => {
